...
function ImageDemo() {
	return (
		<>
			...
			<img
				// 套用config/index.js中的設定值
				src={`${imgServerUrl}/uploads/logo-red.svg`}
				alt=""
				width="100"
				height="100"
			/>
			<img
				//  套用 .env檔中的設定值
				// https://create-react-app.dev/docs/adding-custom-environment-variables/
				src={`${process.env.REACT_APP_DEV_SERVER_URL}/uploads/logo-red.svg`}
				alt=""
				width="100"
				height="100"
			/>
      ...
      */}
			<img src={`${imgUrl}/uploads/anya-300-03.png`} alt="" width="100" height="100" />
		</>
	);
}
